...
class ProspectBranchController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        $prospects = Prospect::where('prospects.branch', $kode)
        ->select('prospects.*', 'users.nama AS nama')
        ...
        return view('prospect-branch.index', compact('prospects'));
    }
