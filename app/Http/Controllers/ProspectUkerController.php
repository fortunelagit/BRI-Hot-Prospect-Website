...
class ProspectUkerController extends Controller
{
    /**
    ...
    {
        $this->authorize('show-menu', 'prospects-uker');


        $kode = Auth::user()->unit;
        $prospects = Prospect::where('prospects.unit', $kode)->select('prospects.*', 'users.nama AS nama')
        ...
        return view('prospect-uker.index', compact('prospects'));
    }
